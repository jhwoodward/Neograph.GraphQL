...
var _cypher2 = _interopRequireDefault(_cypher);
...
const api = {
  ...
  list: {},
  refreshList: () => _cypher2.default.executeQuery('match (n:Predicate) return ID(n),n', 'row').then(data => {
    const predicates = {};
