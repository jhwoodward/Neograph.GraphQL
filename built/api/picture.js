...
module.exports = function (config) {
    ...
    var getPicture = function getPicture(id) {
    ...
    var getList = function getList(q, options) {
    ...
    var labelQuery = function labelQuery(labels) {
    ...
    var propertyQuery = function propertyQuery(property) {
    ...
    var predicateQuery = function predicateQuery(predicate) {
    ...
    var that = {
        ...
        list: {
            ...
            ,
            */
            predicate: function predicate(params, options) {
            ...
            labelled: function labelled(params, options) {

                var q = labelQuery(params.labels);
                return getList(q, options);
            },

            property: function property(params, options) {
