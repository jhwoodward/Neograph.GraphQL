...
module.exports = function (config) {
    ...
    var that = {
        ...
        schema: function schema() {
            ...
            "match (n:Type) return n,collect(r),collect(p),labels(n)", "row").then(function (data) {});
        },
        ...
        refreshList: function refreshList() {
            ...
            return cypher.executeQuery(
            //NB types would require at least one property to show up here
            "match (n:Type)-[r:PROPERTY]->(p:Property) return n,collect(r),collect(p),labels(n)", "row").then(function (data) {
