...
module.exports = function (config) {
    ...
    var that = {
        ...
        label: function label(_label, txt) {
            if (txt) {
                let q = "";
                if (txt === "*") {
                    q = "match (n:" + _label + ")  return ID(n),n.Lookup,n.Type,n.Label ";
                } else {
                    q = "match (n:" + _label + ") where n.Lookup =~ '(?i).*" + txt + ".*'  return ID(n),n.Lookup,n.Type,n.Label ";
                }
