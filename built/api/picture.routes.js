...
module.exports = function (config, router) {
    ...
    router.route('/picture/get/:id').get(function (req, res) {
        picture.get(req.params.id).then(function (data) {
            // if (!data){
            //     res.sendStatus(204);
            //  }
            //  else{
    ...
    router.route('/picture/getWithRels/:id').get(function (req, res) {
        picture.getWithRels(req.params.id).then(function (data) {
            if (!data) {
                res.sendStatus(204);
            } else {
                res.status(200).json(data);
    ...
    router.route('/pictures/labelled/:labels').get(function (req, res) {
        ...
        picture.list.labelled(req.params, req.query).then(function (data) {
            if (!data) {
                res.sendStatus(204);
            } else {
                res.status(200).json(data);
    ...
    router.route('/pictures/property/:prop/:val').get(function (req, res) {
        picture.list.property(req.params, req.query).then(function (data) {
            if (!data) {
                res.sendStatus(204);
            } else {
                res.status(200).json(data);
    ...
    router.route('/pictures/:predicate/:id').get(function (req, res) {
        picture.list.predicate(req.params, req.query).then(function (data) {
            if (!data) {
                res.sendStatus(204);
            } else {
                res.status(200).json(data);
    ...
    router.route('/pictures').post(function (req, res) {
        picture.list.combined(req.body, req.query).then(function (data) {
            if (!data) {
                res.sendStatus(204);
            } else {
                res.status(200).json(data);
    ...
    router.route('/image/error').post(function (req, res) {
        image.error(req.body).then(function (data) {
            if (!data) {
                res.sendStatus(204);
            } else {
                res.status(200).json(data);
...
//# sourceMappingURL=picture.routes.js.map